...
def test_lambdatest1_1():
    chrome_driver = selenium.webdriver.Chrome("E:\\Rahul_sharma\\Selenium_Testing\\chromedriver.exe")

    chrome_driver.get('https://lambdatest.github.io/sample-todo-app/')
    chrome_driver.maximize_window()

    chrome_driver.find_elements(By.NAME,"li1").click()
    chrome_driver.find_elements(By.NAME,"li2").click()
